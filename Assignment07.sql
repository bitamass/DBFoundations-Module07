...
-- 2017-01-01,Bmassoudi,Created File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment07DB_Bmassoudi')
	 Begin 
	  Alter Database [Assignment07DB_Bmassoudi] set Single_user With Rollback Immediate;
	  Drop Database Assignment07DB_Bmassoudi;
	 End
	Create Database Assignment07DB_Bmassoudi;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment07DB_Bmassoudi;
